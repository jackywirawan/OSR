...
TestData messagetypeData = findTestData('Data Files/Message Type')

seqno = messagetypeData.getValue('seq', 1)
name = messagetypeData.getValue('name', 1)
remarks = messagetypeData.getValue('remarks', 1)
